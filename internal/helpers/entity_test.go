...
func TestCheckEntityForNew(t *testing.T) {
	tests := []struct {
		...
		{"Unknown Entity Type", "unknown", "mystery", "/mock/path/unknown", false, true, "/mock/path/unknown"},
	}
...
func TestCheckEntityForDefine_Component(t *testing.T) {
	tests := []struct {
		name        string
		outputPath  string
		force       bool
...
func TestCheckEntityForDefine_Variant(t *testing.T) {
	tests := []struct {
		name        string
		outputPath  string
		force       bool
